...
class Plunge(IndicatorAbstract):
    def __init__(
        ...
        self.atr_buf = deque(maxlen=self.atr_period)

        self.extreme_period = _extreme_period
        self.high_buf = deque(maxlen=self.extreme_period)
        self.low_buf = deque(maxlen=self.extreme_period)
