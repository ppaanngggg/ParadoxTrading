...
from ParadoxTrading.EngineExt.Futures import BarBacktestExecution, BarPortfolio
...
day_data = fetcher_min.fetchDayData(
    '20171016', '20171021', 'rb1801'
)
